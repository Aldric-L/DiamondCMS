...
Adapté par Aldric L. 2020
*/

global $size_g, $user_g, $view_g;

$size = isset($size_g) ? max(8, min(250, $size_g)) : 48;
$user = isset($user_g) ? $user_g : '';
$view = isset($view_g) ? substr($view_g, 0, 1) : 'f';
