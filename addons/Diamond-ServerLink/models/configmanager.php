...
class configManager{
    ...
    public function __construct(){
        if (!file_exists(ROOT . 'config/serveurs.ini')){
            if (!copy(ROOT . "addons/Diamond-ServerLink/install_files/serveurs.ini", ROOT . "config/serveurs.ini") || !copy(ROOT . "addons/Diamond-ServerLink/install_files/rcon.log", ROOT . "logs/rcon.log")){
    ...
    public function getConfig(){
        return cleanIniTypes(parse_ini_file(ROOT . "config/serveurs.ini", true));
    }
