            ...
            <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="panel-body" class="">
                            <?php if (empty($cats)){ ?>
                            <p style="text-align: center;"><em>Impossible d'ajouter un article tant qu'aucune catégorie n'a été créée ! <br>Vous pouvez créer une catégorie <a href="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/config/"> ici.</a></em></p>
                            <?php }else { ?>
                                ...
                                <?php }else { ?>
                                    <?php foreach ($a['cmd'] as $cmd){  ?>
                                        ...
                                        <?php if (!$cmd['is_manual']){
                                            ...
                                            data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/xhr/delete_task/<?=$cmd['id']; ?>" class="del-saved-task btn btn-sm btn-danger">Supprimer la tâche</button></p>
                                                <hr>
                                            <?php }
