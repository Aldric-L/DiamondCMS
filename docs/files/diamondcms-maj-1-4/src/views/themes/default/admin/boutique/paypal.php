                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body" class="">
                            <form method="post">
                                ...
                                <br><button type="button" class="ppconf btn btn-info mod_button" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/xhr/configpaypal/">Sauvegarder</button></p>
                            </form>
                            <hr>
                            <form method="post">
                                <div class="form-group">
                                ...
                                <p class="text-right">
                                <button type="button" class="addpp btn btn-info mod_button" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/xhr/addpaypal/">Ajouter</button></p>
                            </form>
                        </div>
                    </div>
        </div>
