      ...
      <div class="rows">
            ...
            <div class="col-lg-8">
                ...
                <li>
                 ...
                 <?php if ($c['success']){ ?>
                    - <span style="color: green;"><strong>Terminée avec succès</strong></span> <em>(<a href="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>boutique/getback/<?=$c['uuid']; ?>">Accèder au reçu</a>)</em>
                 <?php }else { ?>
