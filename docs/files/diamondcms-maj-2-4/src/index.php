<?php
   ...
   * @version 1.1 (Build A) - Développement
  ...
  define('DCMS_VERSION', '1.1Ba');
  define('DCMS_INT_VERSION', 4);
  ...
  if ($Serveur_Config['is_install'] != true){
    ...
    header('Location: ' . $Serveur_Config['protocol'] ."://" . $_SERVER['HTTP_HOST'] . WEBROOT . "installation/updater.php");
  }
