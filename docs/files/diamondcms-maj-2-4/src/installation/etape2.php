...
<html>
    ...
    <style>
      ...
      <form method="post">
        ...
        <p class="text-right">
        <button type="button" class="testbdd btn btn-warning mod_button" data-link=" //<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/bdd_test.php">Tester</button>
        <button type="button" id="installbdd" disabled class="installbdd btn btn-danger mod_button" data-link=" //<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/bdd_test.php">Installer la Base de données</button></p>
        </form>
        ...
        data=" //<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/next.php">Passer à l'étape suivante</button></p>
      </div>
      </center>
        ...
        <script src=" //<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/etape2.js"></script>
