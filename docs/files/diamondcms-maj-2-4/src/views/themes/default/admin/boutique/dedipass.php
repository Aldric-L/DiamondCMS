                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body" class="">
                            <form method="post">
                                ...
                                <br><button type="button" class="ddconf btn btn-info mod_button" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/xhr/configddp/">Sauvegarder</button></p>
                            </form>
                        </div>
                    </div>
        </div>
