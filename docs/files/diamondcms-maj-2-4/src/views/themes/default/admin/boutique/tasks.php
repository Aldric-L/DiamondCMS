                                ...
                                foreach ($tasks as $t){ 
                                    ...
                                    <a id="line_<?php echo $t['id']; ?>" data="<?php echo $t['id']; ?>" class="list-group-item">
                                        ...
                                        <span class="pull-right text-muted small" style="margin-top: 0; padding: 0;">
                                            <?php if ($t['done'] != true && $t['done'] != 1 ){ ?>
                                            <button 
                                                data-link="<?php echo $config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/tasks/xhr/stop/<?php echo $t['id']; ?>" 
                                                style ="padding-left: 8px; padding-right: 8px; padding-top: 1px; padding-bottom: 1px;" 
                                ...
                                <?php }else { ?>
                                    <a id="line_<?php echo $t['id']; ?>" data="<?php echo $t['id']; ?>" class="list-group-item">
                                        ...
                                        <span class="pull-right text-muted small" style="margin-top: 0; padding: 0;">
                                            ...
                                            <button 
                                                data-link="<?php echo $config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/tasks/xhr/done/<?php echo $t['id']; ?>" 
                                                style ="padding-left: 8px; padding-right: 8px; padding-top: 1px; padding-bottom: 1px;" 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="embed-responsive embed-responsive-16by9">
            <iframe  src="<?php echo $config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/boutique/iframe/<?php echo $c['uuid']; ?>" frameborder="0"></iframe>
        </div>
      </div>
