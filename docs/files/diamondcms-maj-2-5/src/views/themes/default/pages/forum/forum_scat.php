...
<div id="fh5co-page-title" style="background-image: url(<?= LINK; ?>views/uploads/img/<?php echo $Serveur_Config['bg']; ?>)">
  ...
  <div class="text">
    <h1>Forum -> <a class="no" href="<?php echo LINK . 'forum/' ?>"><?php echo $cat['titre']; ?></a> -> <?php echo $sous_cat['titre']; ?></h1>
  </div>
</div>
...
if (isset($_SESSION['pseudo']) && !empty($_SESSION['pseudo'])){?>
  ...
  <br /></br />
<?php }else {?>
<p class="text-center"><em>Une question ? Pour créer un sujet <a href="<?php echo LINK . 'connexion'; ?>"> <i class="fa fa-key" aria-hidden="true"></i> Connectez-vous !</a></em><p>
<br /><br />
<?php } ?>
