...
<div id="fh5co-page-title" style="background-image: url(<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>views/uploads/img/<?php echo $Serveur_Config['bg']; ?>)">
  ...
  <div class="text">
    <h1><a class="no" href="<?php echo $Serveur_Config['protocol']; ?>://<?php echo $_SERVER['HTTP_HOST'] . WEBROOT . 'boutique/' ?>">Boutique </a>-> Récupération des <?= $Serveur_Config['Serveur_money']; ?>s</h1>
  </div>
</div>
<style>
a.no {
...
<div class="container">
    ...
    <?php if (!$errors){ ?>
        <div class="col-lg-12">
            ...
            <?php } ?>
            <p>Vous pouvez dès maintenant dépenser vos <?= $Serveur_Config['Serveur_money']; ?>s sur <a style="color: #197d62;" href="<?php echo $Serveur_Config['protocol']; ?>://<?php echo $_SERVER['HTTP_HOST'] . WEBROOT . 'boutique/' ?>">notre boutique !</p></p>
        </div>
    <?php }else { ?>
        <div class="col-lg-12">
