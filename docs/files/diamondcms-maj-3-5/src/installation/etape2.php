...
<html>
    ...
    <style>
      ...
      <form method="post">
        ...
        <p class="text-right">
        <button type="button" class="testbdd btn btn-warning mod_button" data-link="<?= LINK; ?>installation/bdd_test.php">Tester</button>
        <button type="button" id="installbdd" disabled class="installbdd btn btn-danger mod_button" data-link="<?= LINK; ?>installation/bdd_test.php">Installer la Base de données</button></p>
        </form>
