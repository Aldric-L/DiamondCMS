        ...
        if (!empty($staff)){
          ...
          foreach ($staff as $staffs) {?>
            <div class="col-sm-3">
              ...
              <p class="text-center bree-serif"><a href="<?php echo LINK . 'compte/' ?><?php echo $staffs['pseudo']; ?>"><button type="button" class="btn btn-primary acc">Voir le profil</button></a></p>
            </div><!-- /.col-lg-4 -->
            <?php $i = $i+1;
            if ($i == 4){ $i=0; ?>
    ...
    <div class="row">
      ...
      <?php }else { ?>
        ...
        <?php } ?>
          ...
          <p class="text-center bree-serif"><a href="<?php echo LINK . 'news/' ?><?php echo $n['id']; ?>"><button type="button" class="btn btn-primary acc">En savoir plus...</button></a></p>
          </div>
        <?php }
       } ?> 
    </div>
