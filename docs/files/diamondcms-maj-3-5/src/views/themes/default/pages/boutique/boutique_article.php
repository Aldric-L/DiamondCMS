...
<div id="fh5co-page-title" style="background-image: url(<?= LINK; ?>views/uploads/img/<?php echo $Serveur_Config['bg']; ?>)">
  ...
  <div class="text">
    <h1><a class="no" href="<?php echo LINK . 'boutique/' ?>">Boutique </a>-> <?php echo $article['name']; ?></h1>
  </div>
</div>
<br />
<!-- Page Content -->
      ...
      <div class="row">
        ...
        <div class="col-lg-3">
          ...
          <div class="list-group">
            ...
            <a href="<?= LINK; ?>" class="list-group-item">Revenir à la liste des articles</a>
          </div>
        </div>
        <!-- /.col-lg-3 -->
...
<div id="buy_modal" class="modal fade">
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-success buy" data="<?php echo LINK . 'boutique/buy/' . $article['id']; ?>">Acheter</button>
