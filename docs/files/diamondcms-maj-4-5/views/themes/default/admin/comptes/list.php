  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <!--<a href="#" id="ban_button">--><button type="button" class="btn btn-danger ban_button" data-link="<?= LINK; ?>admin/comptes/list/ban/" data="<?= $c['id']; ?>">Valider</button><!--</a> -->
        </div>
      </div>
  </div>
</div>
  ...
  <div class="modal-dialog">
      <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post">
                    <div class="container-fluid">
                        <div class="rows">
                            <div class="col-lg-4">
                                <img class="img-rounded img-responsive" src="<?= LINK; ?>getprofileimg/<?php echo $c['pseudo']; ?>/175">
                            </div>
                            <div class="col-lg-8">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-success mod_button" data-link="<?= LINK; ?>admin/comptes/list/mod/" data="<?= $c['id']; ?>">Enregistrer</button>
          <?php if ($c['profile_img'] != "profiles/no_profile.png"){ ?>
               <button class="btn btn-warning supp_profile_img" data-link="<?= LINK; ?>admin/comptes/list/supp_profile_img/" data="<?= $c['id']; ?>">Réinitialiser la photo de profil</button>
          <?php } else { ?>
