                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body" class="">
                            <?php if ($config['en_forum']){ ?>
                                <p><strong>Pour désactiver le forum par défaut, cliquez-ici : </strong><button data="<?= LINK; ?>admin/forum/enable" type="submit" class="enable btn btn-danger btn-md">Désactiver</button></p>
                                <hr>
                                <p><em>Pour modifier ces réglages, désactivez dabord le forum par défaut.</em></p>
                            <?php }else { ?>
                                <p><strong>Pour activer le forum par défaut, cliquez-ici : </strong><button data="<?= LINK; ?>admin/forum/enable" type="submit" class="enable btn btn-success btn-md">Activer</button></p>
                                <hr>
                            <?php } ?>
                                ...
                                foreach ($cats as $c){ ?>
                                    <a id="line_<?php echo $c['id']; ?>" data="<?php echo $c['id']; ?>" class="list-group-item">
                                        ...
                                        <span class="pull-right text-muted small" style="margin-top: 0; padding: 0;">
                                            <button 
                                            data="<?= LINK; ?>admin/forum/delete/<?php echo $c['id']; ?>" 
                            ...
                            <?php }else { 
                                foreach ($scats as $c){ ?>
                                    <a id="line_scat_<?php echo $c['id']; ?>" data="<?php echo $c['id']; ?>" class="list-group-item">
                                        ...
                                        <span class="pull-right text-muted small" style="margin-top: 0; padding: 0;">
                                            <select style="display: none" data-link="<?= LINK; ?>admin/forum/moove/<?= $c['id']; ?>" id="cats_available">
                                            ...
                                            <button 
                                            data="<?= LINK; ?>admin/forum/delete_scat/<?php echo $c['id']; ?>" 
                                            id="<?php echo $c['id']; ?>" type="submit" style ="padding-left: 8px; padding-right: 8px; padding-top: 1px; padding-bottom: 1px;" 
