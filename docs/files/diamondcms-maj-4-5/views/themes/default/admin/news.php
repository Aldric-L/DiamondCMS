            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php if ($n['img'] != "noimg"){ ?>
                        <p class="text-center"><img class="img-rounded" src="<?php echo LINK;?>views/uploads/img/<?php echo $n['img'];?>" alt="<?php echo $n['name'];?>" /></p>
                        <?php } ?>
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="#" class="supp_new" id="<?php echo $n['id']; ?>" data="<?= LINK; ?>admin/news/del_news_from_modal/<?php echo $n['id']; ?>"><button type="button" class="btn btn-danger btn_news_del_<?php echo $n['id']; ?>">Supprimer</button></a>
                    </div>
                </div>
            </div>
        </div>                   
