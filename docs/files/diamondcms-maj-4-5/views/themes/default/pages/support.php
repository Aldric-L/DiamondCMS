    ...
    <div class="col-lg-3">
      ...
      <div class="actions">
        ...
        <div class="actions_content">
            ...
            <h5 class="text-center"><button class="btn btn-success acc" style="border-color: #197d62;background-color: #197d62;"><a class="no" style="text-decoration: none;color: white;" href="<?= LINK; ?>forum">Retourner sur le forum...</a></button></h5>
        </div>
      </div>
