                            ...
                            <?php foreach ($permissions as $p){ ?>
                                <tr id="line_<?php echo $p['id']; ?>">
                                    ...
                                    <?php if ($p['can_be_deleted']){ ?>
                                        <td><a href="#" class="supp_role" id="<?php echo $p['id']; ?>" data="<?= LINK; ?>admin/comptes/del_role/<?php echo $p['id']; ?>"><button type="button" class="btn btn-danger btn_role_del_<?php echo $p['id']; ?>">Supprimer</button></a></td>
                                    <?php }else { ?>
