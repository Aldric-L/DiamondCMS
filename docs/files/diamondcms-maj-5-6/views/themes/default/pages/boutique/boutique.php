...
<br />
<div id="explic">
  <h2><?php echo $Serveur_Config['Serveur_name']; ?> vous propose une boutique.</h2>
...
<div class="container">
    <div class="rows">
        ...
        <div class="col-sm-4 col-lg-4">
            ...
            <a href="<?= LINK; ?>boutique/getmoney/"><button class="btn btn-success btn-md" style="background-color: #197d62; border-color: #197d62;">Acheter des <?= $Serveur_Config['Serveur_money']; ?>s</button></a>
        </div>
    ...
    <div class="row">
        ...
        <?php $i = 0; foreach ($l_articles as $key => $article){ $i++;?>
                                <div class="col-lg-4 col-sm-6 text-center">
                                    ...
                                    <h4><span class="bree-serif">Prix : <strong><?php echo $article['prix']; ?> <?php echo $Serveur_Config['Serveur_money']; ?>(s)</strong></span> - <a href="<?= LINK; ?>boutique/article/<?php echo $article['id']; ?>/">En savoir plus... </a></h4>
