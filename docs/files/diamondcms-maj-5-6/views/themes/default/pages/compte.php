...
<div class="content-container container content-page">
  ...
  <div class="row">
    <div class="col-sm-4 col-lg-4 col-sm-offset-2 col-lg-offset-2">
        <p style="text-align: right;"><br><img class="" src="<?= LINK; ?>getprofileimg/<?php echo $pseudo; ?>/200"></p>
    </div>
  ...
  <?php if ($can_ban){?>
    ...
    <a class="supp" data="<?= LINK; ?>compte/supp/<?php echo $infos[0]['pseudo']; ?>/" href="#" style="text-decoration: none; color: black;"><i class="fa fa-trash-o fa-lg"></i> Supprimer toutes ses interventions</a></p>
    <?php if (!$not_user){?>
  ...
  if (!$not_user){ ?>
    ...
    <div class="container">
      <div class="rows">
            ...
            <div class="col-lg-2"></div><!-- ./col-lg-2 -->
            <div class="col-lg-8">
                <?php $payements = $_SESSION['user']->getRealPayements($controleur_def->bddConnexion());
  ...
  <?php } 
    if (!empty($lastactions)){
      ...
      foreach ($lastactions as $key => $lastaction) {
        ...
        echo '<p class="text-right"><a href="'  . LINK . 'forum/com/'. $lastactions[$key]['id_post']['id'] .'/">Retourner sur le sujet...</a></p><br />';
      }
      echo "</div>";
    }else {
      if (!$not_user){
  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-danger" data="<?= LINK; ?>compte/ban/<?php echo $infos[0]['pseudo']; ?>/" id="ban_button">Valider</button>
        </div>
      </div>
  </div>
</div>
