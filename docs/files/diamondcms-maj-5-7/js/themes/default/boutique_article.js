        ...
        $.ajax({
          ...
          success: function (data_rep) {
            ...
            if (data_rep == '0' || data_rep == '2' || data_rep == '3'){
              ...
              alert('Une erreur interne grave est surevenue lors de la réalisation du payement. Malheureusement, il semblerait que la facturation ait quand même été réalisée. Contactez donc au plus vite notre support pour obtenir de l\'aide. Réponse du serveur: ' + data_rep);
            }
          },
          error: function() {
