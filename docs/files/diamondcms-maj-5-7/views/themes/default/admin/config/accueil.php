                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-lg-4"><center>
                                        <h3>
                                            ...
                                            <?php }else { ?>
                                                <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $config['Accueil']['img_1']; ?>" alt="">
                                            <?php } ?>
                                        </h3>
                                    ...
                                    <div class="col-lg-4"><center>
                                        <h3>
                                            ...
                                            <?php }else { ?>
                                                <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $config['Accueil']['img_2']; ?>" alt="">
                                            <?php } ?>
                                        </h3>
                                    ...
                                    <div class="col-lg-4"><center>
                                        <h3>
                                            ...
                                            <?php }else { ?>
                                                <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $config['Accueil']['img_3']; ?>" alt="">
                                            <?php } ?>
                                        </h3>                                        
