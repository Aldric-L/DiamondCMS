                ...
                <div class="panel-body">
                    <form method="post">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="tinymce_en" <?php if ($conf_mce['editor']['enable'] == "1") { ?> checked <?php } ?>>
                            <label class="form-check-label" for="tinymce_en">
                                Activer l'éditeur TinyMCE
                            </label>
                        </div>
                        <div class="form-group">
                            <label for="tinymce_key" class="col-form-label">API Key</label>
                            <input class="form-control" type="text" name="tinymce_key" id="tinymce_key" data-def="<?= $conf_mce['editor']['def_key']; ?>" value="<?= $conf_mce['editor']['key']; ?>">
                        </div>
                        <?php if ($conf_mce['editor']['key'] == $conf_mce['editor']['def_key']){ ?>
                            <p id="alerte_mce"><span style="color:red;">Attention !</span> Vous n'avez pas renseigné votre propre API Key. TinyMCE ne peut pas fonctionner correctement. <a href="https://github.com/Aldric-L/DiamondCMS/wiki/Editeur-de-texte-TinyMCE">Mode d'emploi</a></p>
                        <?php } ?>
                        <hr>
