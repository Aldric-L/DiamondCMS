  ...
  $.ajax({
    ...
    success: function (data_rep) {
      if (data_rep != "" && data_rep != "notable"){
        ...
        alert('Informations valides, vous pouvez continuer. Attention, la base de données n\'existe pas. DiamondCMS va tenter de la créer. Ne poursuivez pas l\'opération si votre hébergeur ne vous autorise pas à créer de base de données.');
