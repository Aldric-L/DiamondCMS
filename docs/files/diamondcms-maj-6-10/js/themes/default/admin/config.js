...
jQuery(function ($){
    $(".mainconf").click(function(){
        $.ajax({
            ...
            type : 'POST',
            data : 'Serveur_name=' + $('#Serveur_name').val() + '&protocol=' + $('#protocol').val() + '&desc=' 
            + $('#desc').val() + '&about_footer=' + $('#about_footer').val() + '&support_en=' 
            + $('#support_en').prop('checked') + '&vote_en=' + $('#vote_en').prop('checked') + '&lien_vote=' 
            + $('#lien_vote').val() + '&socialgl=' + $('#socialgl').val() + '&socialtw=' + $('#socialtw').val() 
            + '&socialyt=' + $('#socialyt').val() + '&socialdiscord=' + $('#socialdiscord').val() + '&socialfb=' 
            + $('#socialfb').val() + '&logo=' + $('#logo').val() + '&favicon=' + $('#favicon').val()
            + '&tinymce_en=' + $('#tinymce_en').prop('checked') + '&tinymce_key=' + $('#tinymce_key').val(),
            dataType : 'html',
            success: function (data_rep) {
                if ($('#tinymce_key').val() != $('#tinymce_key').attr('data-def')){
                    $("#alerte_mce").hide();
                }
