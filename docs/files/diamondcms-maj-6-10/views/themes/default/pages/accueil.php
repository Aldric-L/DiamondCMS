...
<div id="fh5co-hero" >
    <div class="overlay" style="background-image: url(<?= LINK; ?>views/uploads/img/<?php echo $Serveur_Config['bg']; ?>)"></div>
    <div class="container">
    ...
    <div class="container">
        <div class="row">
          ...
          <h3>
            ...
            <?php }else { ?>
              <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $Serveur_Config['Accueil']['img_1']; ?>" alt="">
            <?php } ?>
          </h3>            
          ...
          <h3>
            ...
            <?php }else { ?>
              <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $Serveur_Config['Accueil']['img_2']; ?>" alt="">
            <?php } ?>
          </h3>    
          ...
          <h3>
            ...
            <?php }else { ?>
              <img width="120px" src="<?= LINK; ?>views/uploads/img/<?= $Serveur_Config['Accueil']['img_3']; ?>" alt="">
            <?php } ?>
...
<div class="servers">
  <div class="container">
    <div class="rows">
      <p style="display:none;" id="infos-servers" data-link="<?= LINK; ?>" data-nb="<?php echo $n_serveurs; ?>"></p>
      <h1 class="text-center bree-serif">Etat du réseau <?php echo $Serveur_Config['Serveur_name']; ?></h1><br>
      <h3 id="loader" style="display: block;" class="text-center bree-serif"><img src="<?= LINK; ?>views/uploads/img/ajax-loader.gif" alt="loading" /> Chargement en cours...</h5>
      <?php for ($i=1; $i <= $n_serveurs; $i++){
        if ($i % 2 == 0){?>
          ...
          <div class="col-sm-4 request_depend"><center>
            ...
            <p><a id="link_serveur_<?php echo $i; ?>"class="btn btn-green " href="" role="button">Voir plus &raquo;</a></p>
          </center><br /></div>
        ...
        if (!empty($staff)){
          ...
          foreach ($staff as $staffs) {?>
            <div class="col-sm-3">
              ...
              <p class="text-center bree-serif"><a href="<?php echo LINK . 'compte/' ?><?php echo $staffs['pseudo']; ?>"><button type="button" class="btn btn-green">Voir le profil</button></a></p>
            </div><!-- /.col-lg-4 -->
            <?php $i = $i+1;
            if ($i == 4){ $i=0; ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <?php }else { ?>
        ...
        <div class="col-sm-4">
        <?php if ($n['img'] != "noimg") { ?>
          <p class="text-center"><img style="width: 400px" class="img-rounded" src="<?= LINK; ?>views/uploads/img/<?php echo $n['img'];?>" alt="<?php echo $n['name'];?>"></p>
          <?php }else { ?>
        ...
        <?php } ?>
          ...
          <p class="text-center bree-serif"><a href="<?php echo LINK . 'news/' ?><?php echo $n['id']; ?>"><button type="button" class="btn btn-green">En savoir plus...</button></a></p>
          </div>
        <?php }
       } ?> 
    </div>
