                        ...
                        <div class="panel-body" class="">
                            ...
                            <form>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" name="en_boutique_externe" id="en_boutique_externe" <?php if ($config['en_boutique']){ ?> disabled <?php } ?> <?php if ($config['boutique_ext']['en_boutique_externe'] == "1") { ?> checked <?php } ?>>
                                        <label class="form-check-label">
                                            Activer une boutique externe
                                        </label>
                                    </div>
                                    <div class="row control-group">
                                        <div class="form-group col-xs-12 floating-label-form-group controls">
                                            <label>Lien vers une boutique externe :</label>
                                            <input class="form-control" type="text" value="<?= $config['boutique_ext']['link_boutique_externe']; ?>" name="link_boutique_externe" <?php if ($config['en_boutique']){ ?> disabled <?php } ?> id="link_boutique_externe">
