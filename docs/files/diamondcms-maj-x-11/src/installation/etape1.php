...
<html>
    ...
    <style>
      ...
      <br>
      <center>
      <img class="img-responsive" width="500" style="margin: 0;" src="//<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>/installation/assets/img/diamondcms.png">
      ...
      <div style="padding-top: 10px;margin-left: 15%; margin-right: 15%;">
        ...
        <?php foreach ((is_array(DCMS_DEFAULT_ADDONS_INSTALLED) ? DCMS_DEFAULT_ADDONS_INSTALLED : explode(",", DCMS_DEFAULT_ADDONS_INSTALLED)) as $a){ ?>
          <br>
          <hr width="800">
        ...
        <button class="btn btn-lg btn-success green" id="next_button" data="//<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/next.php">Accepter et passer à l'étape suivante</button></p>
      </div>
      </center>
