...
if ((isset($_GET['action']) && $_GET['action'] == "setDB") OR (isset($_POST['action']) && $_POST['action'] == "setDB")){
...
<html>
    ...
    <style>
      ...
      <br>
      <center>
      <img class="img-responsive" width="500" style="margin: 0;" src="<?php echo LINK;?>/installation/assets/img/diamondcms.png">
      ...
      <?php } ?>
        ...
        data-link="<?= LINK; ?>installation/updater.php" <?php } ?>
