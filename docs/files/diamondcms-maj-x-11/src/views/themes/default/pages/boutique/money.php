<?php global $boutique_config, $paypal_offres, $content_explic; if (sizeof($paypal_offres) <= 3){ $i = 4;}else { $i= 3; } ?>
<div id="fh5co-page-title" style="background-image: url(<?php echo Manager::makeGetImageLink($Serveur_Config['bg']); ?>)">
  <div class="overlay"></div>
  <div class="text">
    <h1><a href="<?php echo LINK . 'boutique/' ?>">Boutique </a>-> Achat de <?= $Serveur_Config['Serveur_money']; ?>s</h1>
  </div>
</div>
<br />
<div id="explic">
        <div class="content-editable" data-apilink="<?php echo LINK . "API/"; ?>" data-page="getmoney"><?php echo $content_explic; ?></div>
</div>
...
<div class="container">
    ...
    <?php if ($boutique_config['PayPal']['en_paypal'] == "true"){ ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-footer text-center">
                        ...
                        <p><em>Vous devez disposer d'un compte sur notre site internet pour procéder au paiement.</em></p>
                                <a class="inscription"><button class="btn btn-custom">S'inscrire</button></a>
        ...
            paypal.Button.render({
                <?php if ($boutique_config['PayPal']['sandbox'] == "true"){ ?>
                      env: 'sandbox', 
                <?php }else { ?>
                      env: 'production', 
                <?php } ?>
