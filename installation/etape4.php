...
<html>
    ...
    <style>
      ...
      <br>
      <center>
      <img class="img-responsive" width="500" style="margin: 0;" src="<?php echo $Serveur_Config['protocol']; ?>://<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>/installation/diamondcms.png">
      ...
      <form method="post" id="conf">
        ...
        data-first="//<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/save_conf.php"
        ...
        <script src="//<?= $_SERVER['HTTP_HOST']; ?><?= WEBROOT; ?>installation/etape4.js"></script>
