...
final class NewUpdate extends Update{
    protected static $update_human_name = "Version 2.0 Alpha (Build A)";
    protected static $update_name = "2.0";
    protected static $update_id = 11;
    protected static $update_date = "1/09/2023";
