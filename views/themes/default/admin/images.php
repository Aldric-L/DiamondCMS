    ...
    <div class="row">
        ...
        <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p><em>Ne sont listées ici que les fichiers se trouvant à la racine du dossier img.</em></p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img class="img-rounded img-responsive" src="<?php echo $Serveur_Config['protocol']; ?>://<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>views/uploads/img/<?php echo $i[1];?>"/>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
                        <a href="#" class="supp_img" id="<?php echo $i[0]; ?>" data="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/images/delete/<?php echo $i[0]; ?>/<?php echo $i[5]; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
                    </div>
                </div>
            </div>
        </div>                   
