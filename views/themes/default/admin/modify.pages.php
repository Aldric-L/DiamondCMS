                        ...
                        <div class="panel-body" class="">
                            <form action"" method="POST">
                                <div class="row control-group">
                                    ...
                                    <button id="delete" 
                                    data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/delete/<?= $page_raw; ?>"
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="panel-body" class="">
                            <div class="embed-responsive  embed-responsive-4by3">
                                <iframe src="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>/<?= $page_raw; ?>" >
                                </iframe>
                            </div>
                        </div>
                    </div>
