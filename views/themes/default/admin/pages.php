                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach ($pages as $p){ ?>
                            <tr>
                                ...
                                <th>
                                <button  
                                    data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/delete/<?= $p['name_raw']; ?>"
                                    data-redirect="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/"
                    ...
                    <table class="table table-striped">
                        ...
                        <?php foreach ($links as $l){ ?>
                            <tr>
                                ...
                                <th>
                                <button  
                                    data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/delete_link/<?= $l['id']; ?>"
                                    data-redirect="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/"
                                     type="submit" class="delete btn btn-danger btn-sm">Supprimer</button></p>
                                </th>
                            </tr>
            ...
            <div class="panel panel-green">
                ...
                <div class="panel-body" class="">
                            <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
                                ...
                                <hr>
                                <div class="rows">
                                    <div class="col-lg-9 list-links" data-nb="<?= sizeof($controleur_def->getFooterPages()); ?>" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/order/footer/" data-type="footer">
                                        <?php $i = 0; foreach ($footer_pages as $p){ 
                                            ...
                                            <div class="item-link" data-id="<?= $p['id']; ?>" style="float: left; padding-left: 6px; padding-right: 6px; padding-top: 12px;" data-pos="<?= $i; ?>" name="<?= $i; ?>" id="link_<?= $p['id']; ?>">
                                                ...
                                                <?= $p['titre']; ?> (<a class="delete_link" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/footer_del/<?= $p['id']; ?>" style="color: red;"><strong><i class="fa fa-trash-o" aria-hidden="true"></i></strong></a>)  
                                    ...
                                    <div class="col-lg-3" style="border-left: 2px solid #eee; ">
                                        ...
                                        <?php foreach ($footer_pages as $p){ 
                                            ...
                                            <div class="item-link-left" style="float: left; width: 100%;" data-pos="<?= $i; ?>" name="<?= $i; ?>" id="link_<?= $p['id']; ?>">
                                                ...
                                                <a class="no arraw-moove-back"  data-redirect-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/footer_add/<?= $p['id']; ?>" data-id="<?= $p['id']; ?>"><strong><i class="fa fa-angle-double-left"></i></strong></a>  
                                                <?= $p['titre']; ?>
                                                </p>
                                            </div>
                                        <?php } }?>
                            ...
                            <div class="container-fluid" style="padding-left: 0px; padding-right: 0px;">
                                ...
                                <div class="rows">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <select style="display: none" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_newmdlink" id="links_available" class="form-control">
                                    ...
                                    <div class="col-sm-3">
                                    <button class="btn btn-success newmd" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_newmd">Créer un nouveau menu déroulant</button>
                                        ...
                                        foreach ($header_md as $md){ ?>
                                            <div class="rows" id="md_<?= $md['id']; ?>">
                                                ...
                                                <p style="text-align: right;">
                                                    <?php if ($md['is_menu']){ ?>
                                                    <button class="btn btn-warning rename_md" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_renamemd/<?= $md['id']; ?>" data-id="<?= $md['id']; ?>">Renommer</button> 
                                                    <?php } ?>
                                                    <button class="btn btn-danger delete_md" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_delmd/<?= $md['id']; ?>" data-id="<?= $md['id']; ?>">Supprimer</button></p>
                                                </div>
                                                <br>
                                                <?php if ($md['is_menu']){ ?>
                                                <div class="col-lg-9 pages-list-md list-links" data-nb="<?= sizeof($md['pages']); ?>" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/order/header/" data-md="<?= $md['id']; ?>" data-type="header">
                                                    <?php $i = 0; foreach ($md['pages'] as $page) { ?>
                                                            <div class="item-link" data-id="<?= $page['id']; ?>" style="margin-left: auto; margin-right: auto;" data-pos="<?= $i; ?>" name="<?= $i; ?>" id="link_<?= $page['id']; ?>">
                                                                ...
                                                                <?= $page['titre']; ?>
                                                                (<a class="delete_link" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_del/<?= $page['id']; ?>" style="color: red;"><strong><i class="fa fa-trash-o" aria-hidden="true"></i></strong></a>)
                                                ...
                                                <div class="col-lg-3" style="border-left: 2px solid #eee; ">
                                                    ...
                                                    <?php foreach ($md['available_pages'] as $p){ ?>
                                                        <div class="item-link-left" style="float: left; width: 100%;" data-pos="" name="" id="link_<?= $p['id']; ?>">
                                                            <p style="text-align: left;">
                                                            <a class="no arraw-moove-back" data-redirect-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/" data-link="<?php echo $Serveur_Config['protocol']; ?>://<?= $_SERVER['HTTP_HOST']; ?><?=WEBROOT; ?>admin/pages/header_add/<?= $md['id']; ?>/<?= $i; ?>/<?= $p['id']; ?>" data-id="<?= $p['id']; ?>"><strong><i class="fa fa-angle-double-left"></i></strong></a>  
                                                            <?= $p['titre']; ?>
                                                            </p>
                                                        </div>
                                                    <?php }?>
