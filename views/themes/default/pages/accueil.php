  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-6 col-sm-4">
        <center>
          <p class="text-center"><img width= 340px height= 161px src="http://<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>views/uploads/img/<?php echo $Serveur_Config['img_1'];?>" alt="<?php echo $Serveur_Config['titre_img_1'];?>"></p>
      ...
      <div class="col-xs-6 col-sm-4">
          <p class="text-center"><img width= 340px height= 161px src="http://<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>views/uploads/img/<?php echo $Serveur_Config['img_2'];?>" alt="<?php echo $Serveur_Config['titre_img_2'];?>"></p>
      ...
      <div class="col-xs-6 col-sm-4">
          <p class="text-center"><img width= 340px height= 161px src="http://<?php echo $_SERVER['HTTP_HOST'];?><?php echo WEBROOT;?>views/uploads/img/<?php echo $Serveur_Config['img_3'];?>" alt="<?php echo $Serveur_Config['titre_img_3'];?>"></p>
