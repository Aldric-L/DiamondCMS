  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-6 col-sm-4">
          ...
          <p id="bree-serif" class="text-center"><a href="<?php echo $Serveur_Config['lien_img_1'];?>"><button type="button" class="btn btn-primary">En savoir plus...</button></a></p>
      </div>
      <div class="col-xs-6 col-sm-4">
          ...
          <p id="bree-serif" class="text-center"><a href="<?php echo $Serveur_Config['lien_img_2'];?>"><button type="button" class="btn btn-primary">En savoir plus...</button></a></p>
      </div>
      <div class="col-xs-6 col-sm-4">
          ...
          <p id="bree-serif" class="text-center"><a class="align-right" href="<?php echo $Serveur_Config['lien_img_3'];?>"><button type="button" class="btn btn-primary">En savoir plus...</button></a></p>
      </div>
    </div>
  </div>
  <br /><br />
